...
func google() {
	...
	url, err := HTTPRequestURL("https://accounts.google.com/o/oauth2/v2/auth", map[string]string{
		"client_id":     clientID,
	...
	log.Println("go to the following link in your browser and complete the sign-in prompts:", url)
